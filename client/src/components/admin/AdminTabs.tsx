          ...
          <div className="rounded-lg border border-white/5 bg-black/30 p-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="rounded-lg border border-white/5 bg-black/20 p-5">
                ...
                <div className="mt-2 flex items-center gap-3">
                  <div className={`h-3 w-3 rounded-full ${settings.showBanner ? 'bg-green-500' : 'bg-gray-500'}`}></div>
                  <p className="text-xl font-semibold">
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-lg border border-white/5 bg-black/20 p-5">
                ...
                <div className="mt-4 grid gap-3">
                  ...
                  >
                    <div className={`mr-2 h-4 w-4 rounded-full ${settings.showSocials ? 'bg-primary' : 'bg-gray-600'}`}></div>
                  ...
                  >
                    <div className={`mr-2 h-4 w-4 rounded-full ${settings.showAnnouncements ? 'bg-primary' : 'bg-gray-600'}`}></div>
                  ...
                  >
                    <div className={`mr-2 h-4 w-4 rounded-full ${settings.showNextStream ? 'bg-primary' : 'bg-gray-600'}`}></div>
